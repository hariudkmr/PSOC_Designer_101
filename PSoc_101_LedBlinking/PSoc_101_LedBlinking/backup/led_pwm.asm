...
;  Global Symbols
;-----------------------------------------------
export  LED_PWM_EnableInt
export _LED_PWM_EnableInt
export  LED_PWM_DisableInt
export _LED_PWM_DisableInt
export  LED_PWM_Start
export _LED_PWM_Start
export  LED_PWM_Stop
export _LED_PWM_Stop
export  LED_PWM_WritePeriod
export _LED_PWM_WritePeriod
export  LED_PWM_WritePulseWidth
export _LED_PWM_WritePulseWidth
export  LED_PWM_bReadPulseWidth
export _LED_PWM_bReadPulseWidth
export  LED_PWM_bReadCounter
export _LED_PWM_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bLED_PWM_ReadPulseWidth    ; deprecated
export _bLED_PWM_ReadPulseWidth    ; deprecated
export  bLED_PWM_ReadCounter       ; deprecated
export _bLED_PWM_ReadCounter       ; deprecated


AREA psoc_101_ledblinking_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_PWM_EnableInt
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_PWM_DisableInt
;
;  DESCRIPTION:
...
;
 LED_PWM_WritePeriod:
_LED_PWM_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[LED_PWM_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_PWM_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 LED_PWM_WritePulseWidth:
_LED_PWM_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[LED_PWM_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_PWM_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 LED_PWM_bReadPulseWidth:
_LED_PWM_bReadPulseWidth:
 bLED_PWM_ReadPulseWidth:                        ; this name deprecated
_bLED_PWM_ReadPulseWidth:                        ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[LED_PWM_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_PWM_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 LED_PWM_bReadCounter:
_LED_PWM_bReadCounter:
 bLED_PWM_ReadCounter:                           ; this name deprecated
_bLED_PWM_ReadCounter:                           ; this name deprecated
   ...
   mov   A, reg[LED_PWM_COMPARE_REG]             ; Save the Compare register on the stack
   push  A                                       ;
   LED_PWM_Stop_M                                ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[LED_PWM_INPUT_REG]               ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[LED_PWM_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[LED_PWM_COUNTER_REG]             ; DR2 <- DR0
   mov   A, reg[LED_PWM_COMPARE_REG]             ; Stash the Count on the stack
   ...
   mov   reg[LED_PWM_INPUT_REG], A               ;
   M8C_SetBank0                                  ;
   LED_PWM_Start_M                               ;   then re-enable the PWM.
