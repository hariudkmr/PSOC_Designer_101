...
export LoadConfig_psoc_101_ledblinking
export _LoadConfig_psoc_101_ledblinking
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_psoc_101_ledblinking
	lcall	LoadConfigTBL_psoc_101_ledblinking_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration psoc_101_ledblinking
;
;    Load configuration registers for psoc_101_ledblinking.
...
;               CUR_PP
;
_LoadConfig_psoc_101_ledblinking:
 LoadConfig_psoc_101_ledblinking:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_psoc_101_ledblinking_Bank0
    mov     X, <LoadConfigTBL_psoc_101_ledblinking_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_psoc_101_ledblinking_Bank1
    mov     X, <LoadConfigTBL_psoc_101_ledblinking_Bank1
